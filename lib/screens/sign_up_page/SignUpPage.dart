...
class _SignUpPageState extends State<SignUpPage> {
  ...
  final TextEditingController _entranceYearInputController = TextEditingController();
                        ...
                        OutlinedButton(
                            ...
                            onPressed: () async {
                              ...
                              await FirebaseFirestore.instance.collection(
                                  ...
                                  .set(
                                  UserModel(
                                      pk: FirebaseAuth.instance.currentUser!
                                          .uid,
                                      name: _nicknameController.text,
                                      major: _majorInputController.text,
                                      entranceYear: _entranceYearInputController
                                          .text,
